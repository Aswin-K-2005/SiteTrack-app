...
}; /* THE FIX: Added missing closing brace here */
...
}; /* THE FIX: Added missing closing braces for the catch block and function */
...
}; /* THE FIX: Added missing closing brace for the listener function */
